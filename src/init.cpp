...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-dustlimit", strprintf(_("Amount of DOGE under which a transaction output is considered dust, in Koinu (default: %u)"), DEFAULT_DUST_LIMIT));
